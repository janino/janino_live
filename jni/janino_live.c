#include "com_janino_live_jni_PushNative.h"
...
JNIEXPORT void JNICALL Java_com_janino_live_jni_PushNative_startPush
...
JNIEXPORT void JNICALL Java_com_janino_live_jni_PushNative_stopPush
  (JNIEnv *env, jobject jobj){
	is_pushing = FALSE;
}


JNIEXPORT void JNICALL Java_com_janino_live_jni_PushNative_release
  (JNIEnv *env, jobject jobj){
 ...
 * 设置视频参数
 */
JNIEXPORT void JNICALL Java_com_janino_live_jni_PushNative_setVideoOptions
 ...
 * 音频编码器配置
 */
JNIEXPORT void JNICALL Java_com_janino_live_jni_PushNative_setAudioOptions
 ...
 * 将采集到视频数据进行编码
 */
JNIEXPORT void JNICALL Java_com_janino_live_jni_PushNative_fireVideo
 ...
 * 对音频采样数据进行AAC编码
 */
JNIEXPORT void JNICALL Java_com_janino_live_jni_PushNative_fireAudio
